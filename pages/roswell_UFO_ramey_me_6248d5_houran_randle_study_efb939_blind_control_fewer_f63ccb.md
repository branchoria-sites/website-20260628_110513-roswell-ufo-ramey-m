...
show_ads: true
description: The neutral control group reported only 1.6 words on average, making it central to judging how much context shaped perception.
hero_summary: The neutral control group reported only 1.6 words on average, making it central to judging how much context shaped perception.
layout: default
permalink: /blind-control/
sidebar_expanded_urls:
- /roswell-ufo-ramey-memo/
- /suggestion-study/
nav_short_title: Blind Control
title: What changed when the story disappeared?
title_full: What changed when the story disappeared?
display_title_short: Blind Control
display_title: Blind Control
heading_title: What changed when the story disappeared?
page_heading_title: What changed when the story disappeared?
source_count: 21
infographic_count: 3
planned_sections:
...
image: /assets/images/roswell_UFO_ramey_me_6248d5_houran_randle_study_efb939_blind_control_fewer_f63ccb-Illustration-1-social.jpg
---
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Useful for understanding the claims surrounding the memo.</p>
        <div class="fr-book-actions">
