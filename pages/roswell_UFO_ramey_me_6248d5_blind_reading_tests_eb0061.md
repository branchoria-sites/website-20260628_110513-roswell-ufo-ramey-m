...
- roswell_UFO_ramey_me_6248d5_blind_reading_tests_eb0061_index
...
show_ads: true
description: The Ramey memo shows why blind methods matter when a researcher already knows the story they hope to confirm.
hero_summary: The Ramey memo shows why blind methods matter when a researcher already knows the story they hope to confirm.
layout: default
permalink: /blind-tests/
sidebar_expanded_urls:
- /roswell-ufo-ramey-memo/
nav_short_title: Blind Tests
title: How to Test a Mystery Photo Fairly
title_full: How to Test a Mystery Photo Fairly
display_title_short: Blind Tests
display_title: Blind Tests
heading_title: How to Test a Mystery Photo Fairly
page_heading_title: How to Test a Mystery Photo Fairly
source_count: 76
infographic_count: 3
planned_sections:
- Remove priming
- Compare independent readers
...
image: /assets/images/roswell_UFO_ramey_me_6248d5_blind_reading_tests_eb0061-overview-social.jpg
---
...
A useful comparison method would ask readers to do three things independently:


<div class="content-enhancement content-enhancement--step-flow" markdown="1">

1. Mark the exact area they are reading.
2. Give the letters or word they think are visible.
3. Assign confidence, including an option for “not readable”.

</div>

Only after that should researchers compare results. If twenty independent readers produce twenty different words in the same location, the result is not strengthened by choosing the most exciting one. If several readers, without priming, choose the same word and can point to the same letter shapes, the result becomes more interesting.
...
This distinction protects both sides of the debate. Pro-Roswell researchers should not have to throw away every visible fragment just because the full memo is unresolved. Sceptics should not have to accept an entire transcript because one or two fragments look suggestive. The honest middle ground is to publish the uncertainty: which marks are stable, which are contested, and which are too ambiguous to carry evidential weight.
...
* **Known-text controls:** Photograph genuine 1940s-style military messages under comparable conditions, then see whether readers and software can recover the words before touching the Ramey image.
* **Blind and double-blind reading:** Readers should not know the case context, and the person administering the test should not know which fragments are expected to matter.
* **Independent scoring:** Proposed words should be scored by location, letter support and reader agreement, not by how well they fit a preferred Roswell narrative.
* **Pre-registered rules:** Researchers should state in advance what counts as convergence, what confidence threshold matters, and how unreadable zones will be reported.
...
## The Practical Standard for a Fair Mystery-Photo Test

A fair reading test for disputed UFO evidence should begin by treating the image as ambiguous until proven otherwise. The Ramey memo shows why: when people know the story they hope to confirm, they may read the story back into the evidence. The practical standard is simple but demanding: remove priming, compare independent readers, separate guesses from evidence, and test the method on known degraded documents before claiming success.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Encourages careful interpretation of data and claims.</p>
        <div class="fr-book-actions">
