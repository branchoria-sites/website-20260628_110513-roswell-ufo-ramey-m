...
show_ads: true
description: Letter spacing and line length became central when Rudiak and Sparks argued that the marks fit Roswell better than Magdalena.
hero_summary: Letter spacing and line length became central when Rudiak and Sparks argued that the marks fit Roswell better than Magdalena.
layout: default
permalink: /letter-fit/
sidebar_expanded_urls:
- /roswell-ufo-ramey-memo/
- /magdalena/
nav_short_title: Letter Fit
title: Did Magdalena Even Fit the Line?
title_full: Did Magdalena Even Fit the Line?
display_title_short: Letter Fit
display_title: Letter Fit
heading_title: Did Magdalena Even Fit the Line?
page_heading_title: Did Magdalena Even Fit the Line?
source_count: 23
infographic_count: 3
planned_sections:
...
image: /assets/images/roswell_UFO_ramey_me_6248d5_magdalena_reading_661502_magdalena_letter_fit_8baf94-Illustration-1-social.jpg
---
...
## Did Magdalena Even Fit the Line?
...
* Does the visible pattern require a long word such as Magdalena?
* Can a shorter alternative account for the same marks?
* Which reading better matches the apparent spacing between neighbouring words?
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides context for the memo controversy.</p>
        <div class="fr-book-actions">
