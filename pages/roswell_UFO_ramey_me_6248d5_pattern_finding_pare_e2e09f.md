...
- roswell_UFO_ramey_me_6248d5_pattern_finding_pare_e2e09f_index
...
show_ads: true
description: The memo is a classic case of how expectation can turn faint marks into meaningful-looking text.
hero_summary: The memo is a classic case of how expectation can turn faint marks into meaningful-looking text.
layout: default
permalink: /pattern-finding/
sidebar_expanded_urls:
- /roswell-ufo-ramey-memo/
nav_short_title: Pattern Finding
title: Why Ambiguous Marks Become Words
title_full: Why Ambiguous Marks Become Words
display_title_short: Pattern Finding
display_title: Pattern Finding
heading_title: Why Ambiguous Marks Become Words
page_heading_title: Why Ambiguous Marks Become Words
source_count: 113
infographic_count: 3
planned_sections:
- Visual ambiguity
- Roswell priming
- How to reduce false certainty
...
image: /assets/images/roswell_UFO_ramey_me_6248d5_pattern_finding_pare_e2e09f-overview-social.jpg
---
...
That distinction explains why digitally enhanced versions can be misleading. Enhancement can increase contrast and make marks more visible, but it cannot automatically restore missing information. It may also make noise look sharper. A clearer-looking image is not necessarily a more truthful image if the processing has amplified artefacts, scratches, grain, compression, or subjective choices about brightness and contrast.
...
<img src="{{ "/assets/images/roswell_UFO_ramey_me_6248d5_pattern_finding_pare_e2e09f-Illustration-3-dark.svg" | relative_url }}" alt="Pattern Finding illustration 3" data-theme-src-dark="{{ "/assets/images/roswell_UFO_ramey_me_6248d5_pattern_finding_pare_e2e09f-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/roswell_UFO_ramey_me_6248d5_pattern_finding_pare_e2e09f-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## How to reduce false certainty

The Ramey memo cannot be made easy, but the risk of false certainty can be reduced. The goal is not to prevent interpretation; it is to separate weak impressions from reproducible evidence.

A cautious method would use several safeguards:

* **[Blind reading]({{ 'blind-reading/' | relative_url }}) first.** Readers should see the memo without being told that it may contain “victims”, “wreck”, “disc”, “balloon”, “Mogul”, or any other target phrase.
...
The practical test is convergence. If a method is reliable, readers using it should increasingly agree on the same letters in the same places, including when they do not know the desired result. If agreement appears only after a phrase has been suggested, that is not strong evidence for the phrase; it is evidence for priming.
...
## What the memo can and cannot bear
