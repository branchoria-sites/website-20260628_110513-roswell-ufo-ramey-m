...
show_ads: true
description: The memo may show active public-story handling, but that is not the same as proof of alien bodies or a hidden craft.
hero_summary: The memo may show active public-story handling, but that is not the same as proof of alien bodies or a hidden craft.
layout: default
permalink: /proof-limits/
sidebar_expanded_urls:
- /roswell-ufo-ramey-memo/
- /crash-story/
nav_short_title: Proof Limits
title: What the 'Crash Story' Clue Can Prove
title_full: What the 'Crash Story' Clue Can Prove
display_title_short: Proof Limits
display_title: Proof Limits
heading_title: What the 'Crash Story' Clue Can Prove
page_heading_title: What the 'Crash Story' Clue Can Prove
source_count: 29
infographic_count: 3
planned_sections:
- The strongest cautious inference from the wording
- Where the UFO interpretation asks too much
- How to separate narrative management from extraordinary proof
...
image: /assets/images/roswell_UFO_ramey_me_6248d5_crash_story_phrase_2eaf01_crash_story_proof_li_17abd0-Illustration-1-social.jpg
---
...
* Discussion of press coverage.
* Clarification of an inaccurate early report.
* Management of confusion between military units.
* Preparation of public statements.
* Deliberate concealment of sensitive information.

</div>

The phrase alone cannot distinguish among those possibilities.
...
A useful analytical approach is to ask what each piece of evidence can prove on its own.

Narrative-management evidence answers questions such as:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* Were officials concerned about public understanding?
* Was information being coordinated across offices?
* Was there an effort to shape or standardise explanations?
* Did different accounts of the event exist simultaneously?

</div>

Extraordinary-proof evidence answers different questions:


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* What object actually crashed or was recovered?
* What materials were involved?
* Were non-human bodies recovered?
* Was there technology beyond known human capabilities?

</div>

The alleged “crash story” phrase belongs almost entirely in the first category.
